...
save_folder_name = 'UNET_DICE'  # folder name
...
# Loss
criterion1 = DiceLoss(apply_activation_function='softmax')  # Dice loss
criterion1.weight = torch.tensor([0.05, 0.35, 0.60])  # Weight for dice loss
