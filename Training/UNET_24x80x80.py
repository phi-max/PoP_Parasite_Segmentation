...
save_folder_name = 'UNET_24x80x80'  # folder name
...
# %% Config file
import unet_framework.data.Microtubules.BG_CM_MT.Training_data.Size_24x80x80.Input as input_dir_training
import unet_framework.data.Microtubules.BG_CM_MT.Training_data.Size_24x80x80.Target as target_dir_training
