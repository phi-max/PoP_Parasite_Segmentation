...
save_folder_name = 'UNET_Binary_MT'  # folder name
...
criterion1.weight = torch.tensor([0.1, 0.9])  # Weight for cross entropy loss
criterion2 = DiceLoss(apply_activation_function='softmax')  # Dice loss
criterion2.weight = torch.tensor([0.1, 0.9])  # Weight for dice loss
